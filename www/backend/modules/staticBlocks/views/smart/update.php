...
/* @var $model backend\modules\staticBlocks\forms\SmartForm*/
/* @var $form yii\widgets\ActiveForm */

$this->title ='Редактирование секции блока "Smart рассылка"';
                    ...
                    <div class="col-md-6">
                        <div class="box">
                            ...
                            <div class="box-body">
                                ...
                                <?= Html::hiddenInput('SmartForm[alias]', $model->alias) ?>
                            </div>
                        </div>
                    </div>
