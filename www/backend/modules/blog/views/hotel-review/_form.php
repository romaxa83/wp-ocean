...
/* @var $hotel_review backend\modules\blog\entities\HotelReview*/
...
<div class="blog-hotel-review-form">
    <div class="row">
            ...
            <div class="box">
                <div class="box-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="box-custome-checkbox">
                                <?= Html::label('Опубликовать', 'status', ['class' => 'tgl-btn']) . Html::checkbox('HotelReviewForm[status]', $model->status, [
                                    'id' => 'status',
                    ...
                    <div class="row">
                        <!-- Tags -->
                        <div class="col-md-6">
                            <?= $form->field($model->tagsReview, 'existing')->widget(Select2::classname(), [
                                'data' => $model->tagsReview->tagsList(),
                                'language' => 'ru',
                                'maintainOrder' => true,
                                'options' => [
                        ...
                        <!-- Image -->
                        <div class="col-md-6">
                            <?= $form->field($model, 'media_ids')->widget(FileInput::className(), [
                                'buttonTag' => 'button',
                                'buttonName' => 'Browse',
                                ...
                                'options' => [
                                    'class' => 'form-control',
                                    'readonly' => 'readonly',
                                    'name' => 'HotelReviewForm[media_ids]'
                                ],
                            ...
                            <?= $form->field($model, 'hide_media')->hiddenInput([
                                    'value' => '[]',
                            ])->label(false); ?>
                        </div>
                    </div>
