<?php
namespace backend\modules\filemanager\widgets;

use Yii;
use yii\helpers\Html;
use yii\widgets\InputWidget;
use backend\modules\filemanager\assets\FileInputAsset;
use yii\helpers\Url;
...
class FileInput extends InputWidget
{
    ...
    public function run()
    {
        ...
        $modal = $this->renderFile('@backend/modules/filemanager/views/file/modal.php', [
