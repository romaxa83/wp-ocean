...
class Tag extends ActiveRecord {
    ...
    public static function removeUnusedTags() {
        return Yii::$app->db->createCommand('DELETE filemanager_tag FROM filemanager_tag LEFT JOIN filemanager_mediafile_tag ON id = tag_id WHERE ISNULL(mediafile_id)')->execute();
    }
