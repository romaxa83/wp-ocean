...
/* @var $searchModel backend\modules\referenceBooks\models\TypeHotelSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */
/* @var $user_settings */
/* @var $page */
/* @var $access backend\modules\user\useCase\Access */

$this->title = 'Справочник типов отелей';
$this->params['breadcrumbs'][] = $this->title;
?>

<div class="referenceBooks-type-hotel-index">
    <div class="row">
        <div class="col-md-12 mb-15">
            <?php if ($access->accessInView(Url::toRoute(['create']))): ?>
                <?= Html::a('Добавить тип отеля', ['create'], ['class' => 'btn btn-primary']); ?>
            <?php endif; ?>
        </div>
    </div>
    <div class="box">
            ...
            GridView::widget([
                ...
                'columns' => [
                    ...
                    [
                        'attribute' => 'media_id',
                        'format' => 'raw',
                        'value' => function (TypeHotel $model) {
                    ...
                    [
                        ...
                        'filter' => [1 => 'Вкл', 0 => 'Выкл'],
                        'headerOptions' => ['width' => '5%'],
                        'value' => function(TypeHotel $model) use ($access) {
                    ...
                    [
                        ...
                        'headerOptions' => ['width' => '5%'],
                        'filter' => '<a href="' . Url::to(['/referenceBooks/type-hotel'], TRUE) . '"><i class="grid-option fa fa-filter" title="Сбросить фильтр"></i></a>',
