...
$this->title = 'Справочник городов вылета';
...
<div class="referenceBooks-dept-city-index">
    <div class="box">
        <div class="box-header">
            <h3 class="box-title">Список городов вылета</h3>
        </div>
            ...
            GridView::widget([
                ...
                'columns' => [
                    ...
                    [
                        ...
                        'headerOptions' => ['width' => '5%'],
                        'template' => '',
                        'filter' => '<a href = "' . Url::to(['/referenceBooks/dept-city'], TRUE) . '"><i class = "grid-option fa fa-filter" title = "Сбросить фильтр"></i></a>'
                    ]
                ]
            ]);
            ?>
