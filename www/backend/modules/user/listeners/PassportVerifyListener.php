...
class PassportVerifyListener extends BaseListener
{
    public function handle(PassportVerify $event) : void
    {
        $notification = $this->notifications_repository->getByAlias('verify-passport-success');
