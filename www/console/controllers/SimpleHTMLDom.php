...
class SimpleHTMLDom extends \yii\helpers\Inflector {
    ...
    public static function curl_request($url, $post = 0, $timeout = 30, $path_to_cookie = '@web/cookie/cookie.txt', $user_agent = 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36') {
        for ($i = 0; $i < 10; $i++) {
        ...
        if ($data == FALSE) {
            \Yii::$app->telegram->sendMessage([
                'chat_id' => '396140135',
                'text' => 'review: ' . \yii\helpers\Json::encode([
                    'data' => 'Change proxy',
                ]),
            ]);
        }
    ...
    public static function file_curl_get_html($url, $post = 0, $timeout = 30, $path_to_cookie = '@web/cookie/cookie.txt', $lowercase = true, $forceTagsClosed = true, $target_charset = DEFAULT_TARGET_CHARSET, $stripRN = true, $defaultBRText = DEFAULT_BR_TEXT, $defaultSpanText = DEFAULT_SPAN_TEXT) {
